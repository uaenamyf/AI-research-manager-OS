...
export function createLiteratureServer(options = {}) {
    ...
    server.registerTool("literature_search", {
        ...
        description: "Search PubMed, Europe PMC, bioRxiv/medRxiv, Crossref, OpenAlex, Semantic Scholar, and arXiv. Sources fan out in parallel by default; results are normalized, deduplicated, and fused deterministically. Returns metadata and short abstracts only, never full text or citation graphs.",
        inputSchema: {
