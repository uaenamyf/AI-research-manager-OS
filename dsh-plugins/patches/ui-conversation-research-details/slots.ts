...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * ResearchOS fusion: the right-column research detail seat — the Paper
     * Intelligence Card the research region selects. Root scope (session-
     * independent); the occupant self-renders nothing when no paper is chosen.
     * Declared by this package's 'details' entry;
