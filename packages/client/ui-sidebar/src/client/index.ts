  ...
  ctx.effect(
    () => ctx.slots.register({
      ...
      children: {
        ...
        // ResearchOS fusion: the research workspace region seated parallel to
        // the workspace browser (@researchos/ui-research-workspace registers).
        'sidebar.research': { kind: 'single', scope: 'root' },
