...
describe('AppFrame', () => {
  ...
  it('keeps details session-independent (research workspace opens without a session); closes only on Session id change', () => {
    ...
    act(() => { instance.actions.openDetails() })
    // 2026-08-20 myf: details 列不再被会话门控（研究区工作台独立于会话）——
    // blank 会话 / 无会话时详情列仍按 store 偏好展开。
