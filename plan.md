...
- [x] `research-project` ✅ 2026-08-17：项目 create/list(分页)/detail/delete，所有查询 `WHERE user_id=?` 归属校验（跨用户访问/删除返回 404 已验）；`research-folder` / `research-paper` / `research-file` 待做。
